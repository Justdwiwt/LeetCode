    ...
    static class RangeModule {
        ...
        public void addRange(int left, int right) {
            ...
            if (entry != intervals.firstEntry()) {
                ...
                if (start != null && start.getValue() >= right) return;
        ...
        public boolean queryRange(int left, int right) {
            Map.Entry<Integer, Integer> entry = intervals.higherEntry(left);
            if (entry == intervals.firstEntry()) return false;
        ...
        public void removeRange(int left, int right) {
            ...
            if (entry != intervals.firstEntry()) {
                ...
                if (start != null && start.getValue() >= right) {
                    ...
                    if (start.getKey() == left) intervals.remove(start.getKey());
                    else intervals.put(start.getKey(), left);
                    if (right != ri) intervals.put(right, ri);
                    return;
